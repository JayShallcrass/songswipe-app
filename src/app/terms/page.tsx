    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 via-white to-pink-50">
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-gray max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">4. Your Account</h2>
            <p className="text-gray-600 leading-relaxed">
              ...
              <a href="mailto:support@songswipe.io" className="text-purple-600 hover:text-purple-700 underline">support@songswipe.io</a>.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">6. Digital Content and Your Right to Cancel</h2>
            <div className="space-y-3 text-gray-600 leading-relaxed">
              <p>
                Under the Consumer Rights Act 2015 and the Consumer Contracts Regulations 2013, you normally have a 14-day cooling-off period for online purchases.
              </p>
              <p>
                However, because SongSwipe delivers digital content (AI-generated songs), and generation begins immediately upon payment, you acknowledge and agree that:
              </p>
          ...
          <section>
            ...
            <div className="space-y-3 text-gray-600 leading-relaxed">
              <p><strong className="text-gray-800">Generation failure:</strong> If all 3 song variants fail to generate due to a technical error on our side, you will receive a full refund.</p>
              <p><strong className="text-gray-800">Quality dissatisfaction:</strong> Because songs are subjective creative works and digital content is delivered immediately, we cannot offer refunds based on personal taste or quality preferences.</p>
              <p><strong className="text-gray-800">Faulty content:</strong> If your song is materially different from what was described (e.g. completely wrong genre, missing personalisation), contact us and we will investigate. You have statutory rights under the Consumer Rights Act 2015 for digital content that is not of satisfactory quality, fit for purpose, or as described.</p>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">8. Song Ownership and Licence</h2>
            <div className="space-y-3 text-gray-600 leading-relaxed">
              <p>When you purchase a song, you receive a <strong className="text-gray-800">personal, non-exclusive, non-transferable licence</strong> to:</p>
              <ul className="list-disc list-inside space-y-2 ml-2">
              ...
              <p>You may <strong className="text-gray-800">not</strong>:</p>
              <ul className="list-disc list-inside space-y-2 ml-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">9. AI-Generated Content</h2>
            <p className="text-gray-600 leading-relaxed">
              All songs are generated by artificial intelligence. While we strive for high quality, please be aware that:
            </p>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed mb-3">When using SongSwipe, you agree not to:</p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">12. Account Suspension and Termination</h2>
            <div className="space-y-3 text-gray-600 leading-relaxed">
              ...
              <p>You may request deletion of your account at any time by contacting{' '}
                <a href="mailto:support@songswipe.io" className="text-purple-600 hover:text-purple-700 underline">support@songswipe.io</a>.
                See our <Link href="/privacy" className="text-purple-600 hover:text-purple-700 underline">Privacy Policy</Link> for details on data retention after account deletion.
              </p>
            </div>
          </section>
