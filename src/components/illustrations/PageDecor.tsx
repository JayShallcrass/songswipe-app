...
export function DecorRings() {
  return (
    <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-[0.06]" viewBox="0 0 1440 600" preserveAspectRatio="xMidYMid slice" fill="none" aria-hidden="true">
      <circle cx="1100" cy="300" r="80" stroke="#f59e0b" strokeWidth="0.8" />
      <circle cx="1100" cy="300" r="140" stroke="#f59e0b" strokeWidth="0.5" />
      <circle cx="1100" cy="300" r="200" stroke="#f59e0b" strokeWidth="0.3" />
      <circle cx="300" cy="300" r="100" stroke="#f97316" strokeWidth="0.6" />
      <circle cx="300" cy="300" r="170" stroke="#f97316" strokeWidth="0.3" />
    </svg>
  )
}
